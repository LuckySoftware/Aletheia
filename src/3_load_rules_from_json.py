...
# 2. Sube un nivel para obtener la ruta raíz del proyecto (...\DataValidator)
...
if __name__ == "__main__":
    ...
    JSON_FILE_PATH = os.path.join(PROJECT_ROOT, "rules.json")
    
    if not os.path.exists(JSON_FILE_PATH):
        # Ahora el mensaje de error mostrará la ruta completa, que es mucho más clara.
        logging.error(f"El archivo de configuración '{JSON_FILE_PATH}' no fue encontrado.")
    else:
        # 4. Pasa ambas rutas a la función principal
