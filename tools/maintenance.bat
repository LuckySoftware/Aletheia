...
REM =========================================================================
REM SCRIPT DE BACKUP DOCKERIZADO
REM =========================================================================
...
REM archivo comprimido (.tar) en la carpeta local del proyecto.
...
IF "%~nx0"=="backup_docker_correcto.bat" (
...
REM =========================================================================
REM BLOQUE 7: LIMPIAR BACKUPS ANTIGUOS
REM =========================================================================
...
REM =========================================================================
REM BLOQUE 8: LIMPIEZA Y FINALIZACIÓN
REM =========================================================================
...
ECHO [ %TIME% ] Backup finalizado exitosamente.
